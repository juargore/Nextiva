...
import com.nextiva.nextivaapp.android.databinding.ActivityDesignSystemUtilityBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class DesignSystemUtilityActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.design_system_utility_toolbar)
    ...
    private fun bindViews(): View? {
        val binding: ActivityDesignSystemUtilityBinding = ActivityDesignSystemUtilityBinding.inflate(layoutInflater)
        toolbar = binding.designSystemUtilityToolbar
        overrideEdgeToEdge(binding.root)
        return binding.root
    }

    fun newIntent(context: Context): Intent? {
        return Intent(context, DesignSystemUtilityActivity::class.java)
    }
}