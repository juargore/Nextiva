...
import com.nextiva.nextivaapp.android.databinding.ActivityFeatureFlagsBinding
...
class FeatureFlagsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTitle(R.string.feature_flags_toolbar)
    ...
    private fun bindViews(): View? {
        val binding: ActivityFeatureFlagsBinding = ActivityFeatureFlagsBinding.inflate(layoutInflater)
        toolbar = binding.featureFlagsToolbar
    ...
    fun newIntent(context: Context): Intent? {
        return Intent(context, FeatureFlagsActivity::class.java)
    }
}