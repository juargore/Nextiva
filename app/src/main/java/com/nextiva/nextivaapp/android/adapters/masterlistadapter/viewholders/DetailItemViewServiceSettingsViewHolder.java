...
public class DetailItemViewServiceSettingsViewHolder extends DetailItemViewViewHolder {

    public DetailItemViewServiceSettingsViewHolder(@NonNull ViewGroup parent, @NonNull Context context, @Nullable MasterListListener masterListListener) {
        this(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_detail_item_view, parent, false),
             context,
             masterListListener);
    }

    private DetailItemViewServiceSettingsViewHolder(View itemView, @NonNull Context context, @Nullable MasterListListener masterListListener) {
