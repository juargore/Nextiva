...
import com.nextiva.nextivaapp.android.databinding.FragmentSetCallSettingsBlockCallerIdBinding;
...
@AndroidEntryPoint
public class SetCallSettingsBlockCallerIdFragment extends SetCallSettingsBaseFragment<ServiceSettings> {
    ...
    public SetCallSettingsBlockCallerIdFragment() {
        // Required empty public constructor
    }

    public static SetCallSettingsBlockCallerIdFragment newInstance(@NonNull ServiceSettings serviceSettings) {
        ...
        SetCallSettingsBlockCallerIdFragment fragment = new SetCallSettingsBlockCallerIdFragment();
    ...
    private View bindViews(LayoutInflater inflater, ViewGroup container) {
        FragmentSetCallSettingsBlockCallerIdBinding binding = FragmentSetCallSettingsBlockCallerIdBinding.inflate(inflater, container, false);

        mEnabledCheckBox = binding.setCallSettingsBlockCallerIdEnabledCheckBox;
    ...
    public int getLayoutResId() {
        return R.layout.fragment_set_call_settings_block_caller_id;
    }

    @Override
    public int getToolbarTitleStringResId() {
        return R.string.set_call_settings_block_caller_id_toolbar;
    }
    ...
    public String getAnalyticScreenName() {
        return Enums.Analytics.ScreenName.BLOCK_MY_CALLER_ID_SCREEN;
    }
    // --------------------------------------------------------------------------------------------
}
