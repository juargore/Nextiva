...
package com.nextiva.nextivaapp.android.meetings.adapter
...
import com.nextiva.nextivaapp.android.databinding.ItemVideoBinding
import com.nextiva.nextivaapp.android.meetings.MeetingActivity
import com.nextiva.nextivaapp.android.meetings.data.VideoCollectionTile
import com.nextiva.nextivaapp.android.meetings.models.net.MeetingModel
import com.nextiva.nextivaapp.android.meetings.utils.inflate
...
//                }
            ...
            val videoRenderView = holder.itemView.findViewById<DefaultVideoRenderView>(R.id.video_surface)
...
class VideoHolder(
    ...
    lateinit var tileContainer: ConstraintLayout
    private lateinit var videoSurface: DefaultVideoRenderView
    private lateinit var poorConnectionMessage: ConstraintLayout
    private lateinit var onTileButton: ImageButton
    private lateinit var attendeeName: TextView
    private lateinit var videoFilterButton: ImageButton

    private val TAG = "VideoHolder"

    init {
        bindViews(view)
        videoSurface.logger = logger
    }

    fun bindVideoTile(videoCollectionTile: VideoCollectionTile) {
        audioVideo.bindVideoView(videoSurface, videoCollectionTile.videoTileState.tileId)
...
/*            if (SegmentationProcessor.isMachineLearningLibraryLoaded) {
            ...
            onTileButton.visibility = View.VISIBLE
            videoFilterButton.visibility = View.INVISIBLE
/* TBD
...
*/
    ...
    private fun bindViews(view: View) {
        ...
        tileContainer = binding.tileContainer
        videoSurface = binding.videoSurface
        poorConnectionMessage = binding.poorConnectionMessage
        onTileButton = binding.onTileButton
        attendeeName = binding.attendeeName
        videoFilterButton = binding.videoFilterButton
    }
