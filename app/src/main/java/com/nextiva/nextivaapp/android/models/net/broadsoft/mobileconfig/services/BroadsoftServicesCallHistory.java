...
@Root
public class BroadsoftServicesCallHistory extends BroadsoftMobileConfigGeneralSetting implements Serializable {
    ...
    private String mEnhanced;

    public BroadsoftServicesCallHistory() {
    }
