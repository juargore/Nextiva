...
public class BroadsoftBroadWorksAnywhereLocationBody extends BaseBroadsoftBroadWorksAnywhereLocation {
    ...
    public BroadsoftBroadWorksAnywhereLocationBody() {
    }

    public BroadsoftBroadWorksAnywhereLocationBody(@NonNull NextivaAnywhereLocation nextivaAnywhereLocation) {
