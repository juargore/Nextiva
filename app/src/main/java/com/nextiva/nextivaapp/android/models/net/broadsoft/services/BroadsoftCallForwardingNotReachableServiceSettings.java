...
@Root(name = "CallForwardingNotReachable", strict = false)
@Namespace(reference = "http://schema.broadsoft.com/xsi")
public class BroadsoftCallForwardingNotReachableServiceSettings extends BroadsoftGeneralServiceSettings {
    ...
    public BroadsoftCallForwardingNotReachableServiceSettings() {
    }

    public BroadsoftCallForwardingNotReachableServiceSettings(@Nullable Boolean active, @Nullable String forwardToPhoneNumber) {
        super(active);
